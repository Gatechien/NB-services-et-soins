...
class PictureController extends AbstractController
{
    ...
    public function new(Request $request, PictureRepository $pictureRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $picture->setUrlPicture("https://gatechien-server.eddi.cloud/NB-services-et-soin/current/public/images/carrousel/".$url."");
            //$picture->setUrlPicture("https://virginieboissiere-server.eddi.cloud/NB-services-et-soin/current/public/images/carrousel/".$url."");
